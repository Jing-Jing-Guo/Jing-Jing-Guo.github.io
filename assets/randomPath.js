...
function replaceCss(s){
	return s.repalce(/-(\w)/g, function(strMatch, t) {return t.toUpperCase()});
}

	
var w = getCssStyle(colour, innerWidth),
	h = getCssStyle(colour, innerHeight),
	ctx = colour.getContext('2d'),
	minDist = 10,
    maxDist = 30,
    initialWidth = 10,
    maxLines = 100,
